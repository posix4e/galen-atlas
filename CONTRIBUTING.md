...
3. **Draft**: fill in `eng` per segment — plain, readable English. AI assistance is welcome; you remain responsible for the result. Compare every accessible witness, weighting each reading according to translation technique, manuscript history, and the passage.
